...
public class PredefinedCoordinateSystems {
    public static final CoordinateSystem BC_ALBERS_NAD_83 = new CoordinateSystem("BC Albers / NAD 83",
            42102,
            new Albers() {
    ...
    public static final CoordinateSystem GEOGRAPHICS_WGS_84 = new CoordinateSystem("Geographics / WGS 84",
            4326, new LatLong());
    ...
    private static CoordinateSystem createUTMNorth(final int zone) {
        ...
        return new CoordinateSystem("UTM " + (zone < 10 ? "0" : "") + zone +
            "N / WGS 84", 32600 + zone,
