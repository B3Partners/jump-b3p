...
public class RenderingStylePanel extends BasicStylePanel implements StylePanel {
    ...
    void jbInit() throws Exception {
        ...
        vertexCheckBox.setText("Vertices. Size:");
        ...
        fillPatternTipLabel.setText("Tip: After selecting a pattern, use your keyboard\'s up and down keys to see how other patterns " +
    "look in the preview below");
        ...
        centerPanel.add(vertexCheckBox,
            new GridBagConstraints(0, 35, 2, 1, 0.0, 0.0,
                GridBagConstraints.WEST, GridBagConstraints.NONE,
                new Insets(2, 2, 2, 2), 0, 0));
        centerPanel.add(new JLabel("Preview:"),
