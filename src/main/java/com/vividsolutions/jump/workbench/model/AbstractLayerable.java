...
public abstract class AbstractLayerable implements Layerable {
     ...
     * layer when they change. But if a party adds or removes a feature, or applies
     * an EditTransaction
     * to a feature, #fireAppearanceChanged will be called automatically.
     * This event will be ignored if LayerManager#isFiringEvents is false
     */
    ...
    //<<TODO:REFACTORING>> Move Visible to LayerSelection, since it should be a property
