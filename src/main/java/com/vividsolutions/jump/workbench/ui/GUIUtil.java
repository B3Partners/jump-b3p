...
public class GUIUtil {
    ...
    /**
     * Returns a string suitable for embeddind as HTML. That is, all characters
        ...
        return new JFileChooser() {
            ...
            public void approveSelection() {
                ...
                for (int i = 0; i < files.length; i++) {
                    if (!files[i].exists() && !files[i].isFile()) { return; }
                }
    ...
    public static class FileChooserWithOverwritePrompting extends JFileChooser {
        ...
        public void approveSelection() {
            if (selectedFiles(this).length != 1) { return; }
    ...
    public static void fixEditableComboBox(JComboBox cb) {
        ...
        if (!UIManager.getLookAndFeel().getName().equals("Windows")) { return; }
        ...
        return new FileFilter() {
            ...
            public boolean accept(File f) {
                ...
                for (int i = 0; i < extensions.length; i++) {
                    if (GUIUtil.getExtension(f).equalsIgnoreCase(extensions[i])) { return true; }
                }
     ...
     * 4522198 in Sun's Java bug database). This method is a workaround that
     * returns null if an exception is thrown, as suggested in the bug reports.
     */
    ...
    public static void sync(final JSlider s, final ValidatingTextField t) {
        ...
        s.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                if (changing[0] == Boolean.TRUE) { return; }
    ...
    public static void syncEnabledStates(final JComponent c1,
        ...
        c1.addPropertyChangeListener("enabled", new PropertyChangeListener() {
            ...
            public void propertyChange(PropertyChangeEvent evt) {
                if (c1.isEnabled() == c2.isEnabled()) { return; }
    ...
    public static Component topCard(Container c) {
        ...
        for (int i = 0; i < components.length; i++) {
            if (components[i].isVisible()) { return components[i]; }
        }
    ...
    public static Component getDescendantOfClass(Class c, Container container) {
        for (int i = 0; i < container.getComponentCount(); i++) {
            if (c.isInstance(container.getComponent(i))) { return container
                    .getComponent(i); }
    ...
    public static class Location {
         ...
         * 
         * @param fromBottom
         *                   whether y is the number of pixels between the bottom
         *                   edges of the toolbox and desktop pane, or between the top
         *                   edges.
         */
