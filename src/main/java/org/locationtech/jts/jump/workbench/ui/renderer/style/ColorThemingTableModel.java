...
import org.locationtech.jts.jump.util.ImmutableFirstElementList;
import org.locationtech.jts.jump.util.Range;
import org.locationtech.jts.jump.workbench.ui.ColumnBasedTableModel;
...
public class ColorThemingTableModel extends ColumnBasedTableModel {
    ...
    protected List createColumns(final FeatureSchema schema) {
        ...
        columns.add(new Column("Attribute Value", null) {
