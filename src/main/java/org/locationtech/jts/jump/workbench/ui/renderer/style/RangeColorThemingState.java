...
public class RangeColorThemingState implements ColorThemingStylePanel.State {
    ...
    public String getAllOtherValuesDescription() {
        return "(Values below these values)";
    }
    public String getAttributeValueColumnTitle() {
        return "Minimum Attribute Values";
    }
    ...
    private JButton reverseButton = new JButton("Reverse Colors");
    ...
    private JLabel label = new JLabel("Range count:");
