...
import org.locationtech.jts.jump.util.commandline.CommandLine;
import org.locationtech.jts.jump.util.commandline.OptionSpec;
import org.locationtech.jts.jump.util.commandline.ParseException;
import org.locationtech.jts.jump.workbench.driver.DriverManager;
import org.locationtech.jts.jump.workbench.plugin.PlugInManager;
import org.locationtech.jts.jump.workbench.ui.SplashPanel;
import org.locationtech.jts.jump.workbench.ui.SplashWindow;
...
public class JUMPWorkbench {
    ...
    //<<TODO:REFACTORING>> Move images package under org.locationtech.jts.jump.workbench
     ...
     */
    public JUMPWorkbench(String title,
                         String[] args,
                         ImageIcon icon,
                         final JWindow s,
    ...
    public static void main(String[] args) {
        try {
            ...
            SplashPanel splashPanel = new SplashPanel(splashImage(), "Version " + VERSION_TEXT);
    ...
    public static void main(String[] args,
        ...
        try {
            ...
            JUMPWorkbench workbench = new JUMPWorkbench(title,
                    args,
                    APP_ICON,
                    splashWindow,
                    taskMonitor);
