...
import org.locationtech.jts.jump.workbench.ui.plugin.clipboard.PasteItemsPlugIn;
        ...
        return new MultiEnableCheck()
            ...
            .add(new EnableCheck() {
                public String check(JComponent component) {
                    ...
                    ? "A layer other than '" + new WarpingVectorLayerFinder(workbenchContext).getLayerName() + "' must be selected" : null;
                }
            });
    }
