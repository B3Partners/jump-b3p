...
import org.locationtech.jts.jump.workbench.ui.AnimatedClockPanel;
...
public class TaskMonitorDialog extends JDialog implements TaskMonitor {
    ...
    public TaskMonitorDialog(Frame frame, ErrorHandler errorHandler, boolean modal) {
        ...
        addWindowListener(new WindowAdapter() {
                ...
                public void windowClosing(WindowEvent evt) {
                    //The user has hit the close ("X") button. [Jon Aquino]
    ...
    private void jbInit() throws Exception {
        ...
        subtaskProgressLabel.setText("Subtask Progress Goes Here");
        taskProgressLabel.setText("Task Progress Goes Here");
