...
import org.locationtech.jts.jump.workbench.ui.TextFrame;
public class VerticesInFencePlugIn extends AbstractPlugIn {
    ...
    private String description(Layer layer, PlugInContext context) {
        ...
        String description =
            "<Table width=100%><tr><td colspan=2 valign=top><i>Layer: </i><font color='#3300cc'><b>"
                + layer.getName()
                + "</b></font></td></tr>";
        ...
        for (Iterator i =
            ...
            description
                += ("<tr bgcolor="
                    + bgcolor
                    + "><td width=10% valign=top><font size='-1'><i>Feature ID: </i></font><font size='-1' color='#3300cc'><b>"
                    + feature.getID()
                    + "</b></font><td>");
