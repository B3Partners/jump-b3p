...
import org.locationtech.jts.jump.workbench.ui.cursortool.*;
import org.locationtech.jts.jump.workbench.ui.snap.*;
...
public class InstallDelineationToolPlugIn extends AbstractPlugIn {
    ...
    public void initialize(PlugInContext context) throws Exception {
        ...
        context.getWorkbenchFrame().getToolBar().addCursorTool("Delineate",
